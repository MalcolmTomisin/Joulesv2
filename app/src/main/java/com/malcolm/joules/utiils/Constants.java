...
public class Constants {
    ...
    public static final String JOULES1 = "joules1";
    public static final String JOULES2 = "joules2";
    public static final String JOULES3 = "joules3";
    public static final String JOULES4 = "joules4";
