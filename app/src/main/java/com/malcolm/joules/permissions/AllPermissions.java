...
public class AllPermissions {
    private static final String TAG = AllPermissions.class.getSimpleName();
    ...
    public static void init(Context context) {
        ...
        AllPermissions.context = context;
    }
    ...
    public static boolean checkPermission(String permissionName) {
        if (context == null) {
            throw new RuntimeException("Before comparing permissions you need to call Allpermissions.init(context)");
        }
